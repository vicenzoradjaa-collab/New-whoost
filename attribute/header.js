class CustomHeader extends HTMLElement {
    connectedCallback() {
        ...
        <header id="navbar-wrapper" class="fixed top-0 left-0 w-full z-50 transition-all duration-500 pt-0 px-0">
            <nav id="navbar-inner" class="max-w-7xl mx-auto px-4 md:px-6 h-16 md:h-20 flex items-center justify-between transition-all duration-500 border border-transparent bg-transparent rounded-none">
                ...
                <a href="index.html" class="flex items-center gap-2 md:gap-3 font-bold text-xl md:text-2xl tracking-tight text-white group">
                    ...
                    <img src="asset/logow.webp" alt="Logo" class="w-10 h-10 md:w-10 md:h-10 object-contain group-hover:scale-105 transition-transform" onerror="this.src='https://via.placeholder.com/32x32.png?text=W'">
                    Whoost.id
                </a>
        ...
        <div class="fixed bottom-5 left-4 right-4 z-50 lg:hidden">
            <!-- max-w-[380px] dan mx-auto memastikan icon lebih rapat ke tengah -->
            <div class="bg-[#121214]/95 backdrop-blur-lg border border-zinc-800 rounded-[2.5rem] px-6 py-3 w-full max-w-[380px] mx-auto flex justify-between items-center shadow-[0_10px_40px_rgba(0,0,0,0.8)]">
                
                <!-- Menu 1: Home -->
                <a href="index.html" class="flex flex-col items-center gap-1.5 text-zinc-400 hover:text-white transition group w-14">
                ...
                <!-- Menu 2: Explore -->
                <a href="explore.html" class="flex flex-col items-center gap-1.5 text-zinc-400 hover:text-white transition group w-14">
                    ...
                    <span class="text-[11px] font-medium tracking-wide">Explore</span>
                </a>
                
                <!-- Menu 3: Boost Income (Tengah & Menonjol Putih - Dibesarkan) -->
                <a href="login.html" class="flex flex-col items-center justify-end group relative w-14 h-[42px]">
                    <div class="absolute -top-8 w-[56px] h-[56px] bg-white rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(255,255,255,0.4)] group-hover:-translate-y-1 transition-all duration-300">
                        <svg class="w-7 h-7 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                    </div>
                    <span class="text-[11px] font-bold text-white tracking-wide">Boost</span>
                </a>

                <!-- Menu 4: FAQ -->
                <a href="faq.html" class="flex flex-col items-center gap-1.5 text-zinc-400 hover:text-white transition group w-14">
                    ...
                    <span class="text-[11px] font-medium tracking-wide">FAQ</span>
                </a>

                <!-- Menu 5: Contact -->
                <a href="contact.html" class="flex flex-col items-center gap-1.5 text-zinc-400 hover:text-white transition group w-14">
                    ...
                    <span class="text-[11px] font-medium tracking-wide">Contact</span>
                </a>
