class CustomHeader extends HTMLElement {
    connectedCallback() {
        ...
        <div class="fixed bottom-5 left-0 right-0 z-50 lg:hidden px-4 flex justify-center">
            ...
            <!-- max-w-[400px] dengan justify-around agar 4 tombol tersebar rata dan rapi -->
            <div class="bg-[#121214]/95 backdrop-blur-lg border border-zinc-800 rounded-[2.5rem] px-2 py-3 w-full max-w-[400px] flex justify-around items-center shadow-[0_10px_40px_rgba(0,0,0,0.8)]">
                
                <!-- Menu 1: Home -->
                <a href="index.html" class="flex flex-col items-center gap-1.5 text-zinc-400 hover:text-white transition group w-16">
                    <svg class="w-6 h-6 sm:w-7 sm:h-7 group-hover:scale-110 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                    <span class="text-[11px] font-medium tracking-wide">Home</span>
                </a>

                <!-- Menu 2: Campaign (sebelumnya Explore) -->
                <a href="explore.html" class="flex flex-col items-center gap-1.5 text-zinc-400 hover:text-white transition group w-16">
                    <svg class="w-6 h-6 sm:w-7 sm:h-7 group-hover:scale-110 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                    <span class="text-[11px] font-medium tracking-wide">Campaign</span>
                </a>

                <!-- Menu 3: FAQ -->
                <a href="faq.html" class="flex flex-col items-center gap-1.5 text-zinc-400 hover:text-white transition group w-16">
                ...
                <!-- Menu 4: Contact -->
                <a href="contact.html" class="flex flex-col items-center gap-1.5 text-zinc-400 hover:text-white transition group w-16">
                    <svg class="w-6 h-6 sm:w-7 sm:h-7 group-hover:scale-110 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
